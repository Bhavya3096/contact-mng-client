    ...
    <div className='form-container'>
        <form className='form' onSubmit={handleSubmit}>
            ...
            <div className='form-group'>
                ...
                <input type="text" placeholder='Enter Name' className='form-control' name='name' onChange={handleInput}></input>
            ...
            <p className='t1'>Already Registered?    <Link to="/login">Login</Link></p>
        </form>
    </div>
  )
}
